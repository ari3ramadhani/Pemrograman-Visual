...
Public Class Form1
    ...
    Private Sub Button6_Click(sender As System.Object, e As System.EventArgs) Handles Button6.Click
        Dim adapter2 As New MySqlDataAdapter("select * from mhs where tanggal_masuk = '" &
                                              Format(DateTimePicker2.Value, "yyyy-MM-dd") & "'", koneksi)
    ...
    Private Sub Button7_Click(sender As System.Object, e As System.EventArgs) Handles Button7.Click
        Dim adapter3 As New MySqlDataAdapter("select * from mhs where tanggal_masuk BETWEEN '" &
                                            Format(DateTimePicker3.Value, "yyyy-MM-dd") &
                                             "' And '" & Format(DateTimePicker4.Value, "yyyy-MM-dd") & "'", koneksi)
        Dim tabel3 As New DataTable
        adapter3.Fill(tabel3)
